...
RELEASE_TAG="project-gen-world-${PARK_PRESET}-latest"
RELEASE_TITLE="Project Gen — latest ${PARK_PRESET//-/ } world"
NOTES_FILE="${RUNNER_TEMP:-${TMPDIR:-/tmp}}/${RELEASE_TAG}-notes.md"

{
  printf '%s\n' "Direct Minecraft Bedrock world generated by **Project Gen** for **${PARK_PRESET}**."
  printf '\n'
  printf '%s\n' "Generated from Project Gen commit \`${GITHUB_SHA}\` by [Actions run ${GITHUB_RUN_NUMBER:-unknown}](https://github.com/${GITHUB_REPOSITORY}/actions/runs/${GITHUB_RUN_ID:-})."
